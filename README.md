...
The version number is a mix of the InvenTree release (1.2) and the schema version (453) with point releases after that when multiple client jars are released against the same schema.
