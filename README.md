...
The version number is a mix of the InvenTree release (1.5) and the schema version (530) with point releases after that when multiple client jars are released against the same schema.
