...
public class TestGenericApi extends TestApi {
    ...
    public void genericStatusCustomList() throws ApiException {
        ...
        PaginatedCustomStateList actual = api.genericStatusCustomList(limit, offset, null, null);
    ...
    public void genericStatusRetrieve(String statusModel) throws ApiException {
